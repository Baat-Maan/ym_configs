...
class ResConfigSettings(models.TransientModel):
    ...
    save_customer_branch = fields.Boolean(string='Save Customer Branch To Beta', config_parameter='ym_configs.save_customer_branch')
    customer_branch_endpoint = fields.Char(string='Customer Beta Endpoint', config_parameter='ym_configs.customer_branch_endpoint')
    ...
    sales_head_contact = fields.Char(string='Sales Team Head', size=10, config_parameter='ym_configs.sales_head_contact')
    accounts_head_contact = fields.Char(string='Accounts Team Head', size=10, config_parameter='ym_configs.accounts_head_contact')
